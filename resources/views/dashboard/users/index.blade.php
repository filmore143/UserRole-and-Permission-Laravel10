...
<section class="content-main">
    <div class="content-header">
        ...
        <div>
            <a href="{{route('user.create')}}" class="btn btn-primary"><i class="text-muted material-icons md-post_add"></i>Add User</a>
        </div>
    </div>
                             ...
                             <form action="{{route('user.destroy', $value->id)}}" method="post">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{route('user.edit', $value->id)}}">Edit info</a>
